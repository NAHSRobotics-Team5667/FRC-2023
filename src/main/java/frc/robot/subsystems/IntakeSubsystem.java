...
import frc.robot.util.RevTimeOfFlight.Port;
import frc.robot.util.RevTimeOfFlight.Unit;
...
public class IntakeSubsystem extends SubsystemBase {
    ...
    private RevTimeOfFlight m_distanceSensor;
    ...
    public IntakeSubsystem() {
        ...
        m_distanceSensor = new RevTimeOfFlight(Port.kOnboard);
