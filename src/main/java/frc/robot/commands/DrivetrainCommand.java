...
public class DrivetrainCommand extends CommandBase {
        ...
        private void joystickDrive() {
                ...
                double xSpeed = xspeedLimiter
                                .calculate(MathUtil
                                                .applyDeadband(-RobotContainer.driveController.getLeftX()
                                                                * robotContainer.getSpeedMultiplier(),
                                                                0.1))
                ...
                double ySpeed = yspeedLimiter
                                .calculate(MathUtil
                                                .applyDeadband(-RobotContainer.driveController.getLeftY()
                                                                * robotContainer.getSpeedMultiplier(),
                                                                0.15))
                                * DrivetrainSubsystem.kMaxSpeed;
                ...
                double rot = rotLimiter
                                .calculate(MathUtil.applyDeadband(
                                                RobotContainer.driveController.getRightX()
                                                                * robotContainer.getTurnMultiplier(),
                                                0.15))
